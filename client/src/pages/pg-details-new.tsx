...
import { 
  ArrowLeft, MapPin, Star, Wifi, Car, Utensils, Dumbbell, 
  Shield, Zap, Wind, Droplets, Phone, Calendar
} from "lucide-react";
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <span className="ml-1 font-medium">{property.averageRating || "New"}</span>
                      <span className="text-gray-500 ml-1">({property.reviewCount || 0} reviews)</span>
                    </div>
                  </div>
